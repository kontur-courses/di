...
namespace TagsCloudVisualization
{
    ...
    public class FileAnalyzer_GetWordsFrequency_Should
    {
        ...
        {
            var actual = new FileAnalyzer(50, 0).GetWordsFrequensy(new List<string>() {"Hello", "Hello", "!"});
        ...
        {
            var actual = new FileAnalyzer(3, 5).GetWordsFrequensy(File.ReadLines(TestContext.CurrentContext.TestDirectory+"\\book1.txt"));
