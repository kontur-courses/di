...
namespace TagsCloudVisualization
{
    ...
    public class SuperTightCloudLayouter_Should
    {
        ...
        private SuperTightCloudLayouter superTightCloudLayouter;

        [SetUp]
        public void SetUp()
        {
            superTightCloudLayouter = new SuperTightCloudLayouter(center);
        }
        ...
        {
            Action ctorInvocation = () => superTightCloudLayouter.PutNextRectangle(new Size(width, height));
        ...
        public void PutNextRectangle_ReturnRectangleOfSameSize()
        {
            ...
            superTightCloudLayouter.PutNextRectangle(size).Size.Should().Be(size);
        }

        [Test]
        public void PutNextRectangle_OneRectangle_PlaceToCenter()
        {
            var rectangle = superTightCloudLayouter.PutNextRectangle(new Size(100, 20));
        ...
        {
            var firstNextRectangle = superTightCloudLayouter.PutNextRectangle(new Size(10, 20));
            var secondNextRectangle = superTightCloudLayouter.PutNextRectangle(new Size(10, 20));
        ...
        public void PutNextRectangle_ManyRectangles_RectanglesShouldNotIntersect()
        {
            ...
            for (var i = 0; i < 10; i++)
            {
                var newRectangle = superTightCloudLayouter.PutNextRectangle(new Size(10, 20));
        ...
        public void Сloud_ShouldHasShapeOfCircle()
        {
            ...
            for (var i = 0; i < 10; i++)
            {
                rects.Add(superTightCloudLayouter.PutNextRectangle(new Size(10, 20)));
            }
        ...
        public void TearDown()
        {
            ...
            {
                var image = RectanglesRenderer.GenerateImage(superTightCloudLayouter.Rectangles);
