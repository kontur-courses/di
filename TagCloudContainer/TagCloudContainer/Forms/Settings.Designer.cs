...
partial class Settings
{
    ...
    private void InitializeComponent()
    {
        ...
        this.Colors.Items.AddRange(TagCloudContainer.Colors.GetAll().Keys.ToArray());
        ...
        this.BackgroundColors.Items.AddRange(TagCloudContainer.Colors.GetAll().Keys.ToArray());
