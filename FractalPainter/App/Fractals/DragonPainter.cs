    ...
    public class DragonPainter
    {
        ...
        public void Paint()
        {
            ...
            using (var graphics = imageHolder.StartDrawing())
            {
                ...
                {
                    using (var primaryColorBrush = new SolidBrush(palette.PrimaryColor))
                    {
                        graphics.FillRectangle(primaryColorBrush, imageSize.Width / 3f + p.X, imageSize.Height / 2f + p.Y, 1, 1);
                    }
