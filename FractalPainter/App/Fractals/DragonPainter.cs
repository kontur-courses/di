...
namespace FractalPainting.App.Fractals
{
    public class DragonPainter
    {
        ...
        private readonly Palette dragonPalette;
        private readonly float size;
        private Size imageSize;

        public DragonPainter(IImageHolder imageHolder, DragonSettings settings, Palette dragonPalette)
        {
            this.imageHolder = imageHolder;
            this.settings = settings;
            this.dragonPalette = dragonPalette;
        ...
        public void Paint()
        {
            ...
            {
                graphics.FillRectangle(new SolidBrush(dragonPalette.BackgroundColor), 0, 0, imageSize.Width, imageSize.Height);
                var r = new Random();
                ...
                {
                    graphics.FillRectangle(new SolidBrush(dragonPalette.PrimaryColor), imageSize.Width/3f + p.X, imageSize.Height/2f + p.Y, 1, 1);
                    if (r.Next(0, 2) == 0)
