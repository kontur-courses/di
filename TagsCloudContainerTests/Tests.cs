...
namespace TagsCloudContainerTests
{
    ...
    public class CloudLayouterTest
    {
        ...
        protected readonly Point CenterPoint = new Point(500, 500);
        ...
        private IEnumerable<Point> CountPointsOutOfCircle(double circleRadius, List<Rectangle> rectangles, Point centerPoint)
        {
            return rectangles.Select(ToBoundaryPoints).SelectMany(point => point).Distinct()
                .Where(point => PointOutRadius(circleRadius, centerPoint, point));
        }

        private bool PointOutRadius(double circleRadius, Point centerPoint, Point point)
        {
