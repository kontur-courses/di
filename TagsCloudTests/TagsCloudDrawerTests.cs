...
{
    [TestFixture]
    class TagsCloudDrawerTests
    {
        TagsCloudSettings defaultSettings = TagsCloudSettings.DefaultSettings;

        [Test]
        public void GetTagsFromWords_ShouldThrowIfCollectionIsNull()
        {
            var drawer = new TagsCloudDrawer(new RectanglesLayouter(Point.Empty), TagsCloudSettings.DefaultSettings);
            var graphics = Graphics.FromImage(new Bitmap(defaultSettings.ImageSize.Width, defaultSettings.ImageSize.Height));
            Action action = () => drawer.GetTagsFromWords(null, graphics).ToArray();
            action.Should().Throw<ArgumentException>();
        }

        [Test]
        public void GetTagsFromWords_WordWithGreaterWeightShouldBeBigger()
        {
            var drawer = new TagsCloudDrawer(new RectanglesLayouter(Point.Empty), TagsCloudSettings.DefaultSettings);
            var graphics = Graphics.FromImage(new Bitmap(defaultSettings.ImageSize.Width, defaultSettings.ImageSize.Height));
        ...
        [Test]
        public void GetTagsFromWords_WordWithGreaterLengthShouldHaveBiggerWidth()
        {
            var drawer = new TagsCloudDrawer(new RectanglesLayouter(Point.Empty), TagsCloudSettings.DefaultSettings);
            var graphics = Graphics.FromImage(new Bitmap(defaultSettings.ImageSize.Width, defaultSettings.ImageSize.Height));
        ...
        [Test]
        public void GetTagsFromWords_SizeShouldDependOnTheFont()
        {
        ...
        [Test]
        public void DrawTagsCloud_ShouldThrowIfCollectionIsNull()
        {
            var drawer = new TagsCloudDrawer(new RectanglesLayouter(Point.Empty), TagsCloudSettings.DefaultSettings);
            var graphics = Graphics.FromImage(new Bitmap(defaultSettings.ImageSize.Width, defaultSettings.ImageSize.Height));
        ...
        [Test]
        public void GetTagsCloud_ShouldThrowIfCollectionIsNull()
        {
            var drawer = new TagsCloudDrawer(new RectanglesLayouter(Point.Empty), TagsCloudSettings.DefaultSettings);
        ...
        [Test]
        public void GetTagsCloud_ShouldMatchImageSize()
        {
            var drawer = new TagsCloudDrawer(new RectanglesLayouter(Point.Empty), TagsCloudSettings.DefaultSettings);
