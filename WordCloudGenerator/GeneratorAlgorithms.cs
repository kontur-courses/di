...
namespace WordCloudGenerator
{
    public abstract class GeneratorAlgorithms
    {
        ...
        public static Func<IEnumerable<WordFrequency>, IEnumerable<GraphicString>> Proportional => ProportionalAlgorithm;
        ...
        private static IEnumerable<GraphicString> ProportionalAlgorithm(IEnumerable<WordFrequency> wordFrequencies)
        {
            ...
            var recalculatedFrequencies = frequencies.Select(word => new WordFrequency(word.Word, word.Frequency * 2/ freqSum));
