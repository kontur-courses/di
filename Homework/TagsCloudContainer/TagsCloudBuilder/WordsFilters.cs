...
{
    public static class WordsFilters
    {
        public static Dictionary<string, int> RemoveWord(this Dictionary<string, int> words,
            string boringWord)
        {
            return words
        ...
        public static Dictionary<string, int> RemoveWords(this Dictionary<string, int> words,
