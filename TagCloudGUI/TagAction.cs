...
namespace TagCloudGraphicalUserInterface
{
    public class TagAction : IActionForm
    {
        ...
        void IActionForm.Perform()
        {
            ...
            imageSettingsProvider.RecreateImage(new ImageSettings() { Height = sizeCloud.Height, Width = sizeCloud.Width });
            DrawCloud(cloud, imageSettingsProvider, palette);
        }
        public static void DrawCloud(TagCloud tagCloud, IImageSettingsProvider drawImageSettingsProvider,Palette palette)
        {
