...
namespace TagsCloudVisualisation.App.WordsPreprocessor
{
    /// <summary>
    ...
    public class DefaultWordsPreprocessor : IWordsPreprocessor
    {
        ...
        private HashSet<Word.Word> wordsSet;

        public DefaultWordsPreprocessor(CultureInfo cultureInfo)
        {
            this.cultureInfo = cultureInfo;
            wordsSet = new HashSet<Word.Word>();
        }
        ...
        public ISet<Word.Word> GetProcessedWords(List<string> words, IReadOnlyCollection<IBoringWords> boringWords)
        {
        ...
        private static void CalculateTfIndexes(IEnumerable<Word.Word> words, int totalWordsCount)
        {
        ...
        private static HashSet<Word.Word> CreateWordsSet(IEnumerable<string> words, Func<string, string> wordPreprocessor)
        {
            var set = new HashSet<Word.Word>();
            foreach (var word in words.Select(wordValue => new Word.Word(wordPreprocessor(wordValue))))
            {
